...
class Congratulation(models.Model):
    _name = "congratulation"
    _description = "Company Congratulation"
    _inherit = "notify"
    ...
    def action_toggle_like(self):
        ...
        if not (self.env.user.has_group(
                "realty_bds.access_group_user_congratulation") or self.env.user
                .has_group("realty_bds.access_group_realty_congratulation")):
            raise AccessError(
    ...
    def _get_permission_info(self):
        ...
        extra = {
            ...
            "moderator_group": "realty_bds.access_group_mod_congratulation",
            "realty_group": "realty_bds.access_group_realty_congratulation",
            "user_group": "realty_bds.access_group_user_congratulation",
        }
        base.update(extra)
        return base
