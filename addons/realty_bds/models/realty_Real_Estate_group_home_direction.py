...
class GroupHomeDirection(models.Model):
    _name = "group_home_direction"
    _description = "Real Estate Group Home Direction"
    ...
    home_direction_ids = fields.One2many(
        "home_direction", "group_id", string="Home Direction", tracking=True
    )
    ...
    _sql_constraints = [
        (
            "group_home_direction_unique_name",
            "UNIQUE(name)",
